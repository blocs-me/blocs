...
const paraOne =
  'Live weather conditions right inside your Notion workspace. See the current temperature, forecast, and conditions for any city — no API key needed.'
  ...
  return (
    ...
    >
      {() => (
        ...
        >
          <DummyWeatherPreview showCta={false} />
        </Box>
      )}
    </WidgetExplainerSection>
  )
