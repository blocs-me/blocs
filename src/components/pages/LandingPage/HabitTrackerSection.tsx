...
const paraOne =
  'Have a new habit you want to create ? No problem! With our habit tracker widget you can create any habit and watch the list refresh everyday to tick off again ☑️'
const paraTwo =
